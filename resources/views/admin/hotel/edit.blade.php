...
@section('content')
    ...
    <div class="col-md-12">
        <div class="card card-outline card-primary">
            ...
            <form action="/hotel/update/{{ $hotel->id_hotel }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="nama_hotel" value="{{ $hotel->nama_hotel }}" class="form-control" placeholder="Nama Hotel">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_bintang" class="form-control">
                                    <option value="{{ $hotel->id_bintang }}">{{ $hotel->bintang }}</option>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_kecamatan" class="form-control">
                                    <option value="{{ $hotel->id_kecamatan }}">{{ $hotel->kecamatan }}</option>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="alamat" value="{{ $hotel->alamat }}" class="form-control" placeholder="Alamat Hotel">
                                <div class="text-danger">
                                    @error('alamat')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi" class="form-control" placeholder="Deskripsi Hotel" rows="5">{{ $hotel->deskripsi }}</textarea>
                                <div class="text-danger">
                                    @error('deskripsi')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $hotel->posisi }}" name="posisi" id="posisi" class="form-control" placeholder="Posisi Hotel" readonly>
                                <div class="text-danger">
                                    @error('posisi')
                                        {{ $message }}
                                    @enderror
