                    ...
                    <tbody>
                        ...
                        @foreach ($user as $data)
                            <tr>
                                ...
                                <td>{{ $data->name }}</td>
                                <td>{{ $data->email }}</td>
                                <td><img style="object-fit: cover;" src="{{ asset('foto') }}/{{ $data->foto }}" width="50px" height="70px"></td>
    ...
    @foreach ($user as $data)
        <div class="modal fade" id="delete{{ $data->id }}">
            ...
            <div class="modal-content bg-danger">
                ...
                <a href="/user/delete/{{ $data->id }}" type="button" class="btn btn-outline-light">Hapus</a>
                </div>
            </div>
            <!-- /.modal-content -->
            </div>
